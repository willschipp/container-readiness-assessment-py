...
function Home() {
    ...
    return (
        <Content width="calc(100% - size-1000)">
            ...
            <p>
                The application uses a Large Language Model (LLM) to perform and assessment and generate starter files
                to help users get started with Kubernetes for their application.
            </p>
            ...
            <p>
                ...
                In the background, the backend will then analyze the application build files to assess if it can be deployed - as is - 
                to Kubernetes.  If it can, a series of starter files will be created.
            </p>
            <p>
            ...
            <p>
                Once your application has been assessed, if if can be deployed, you can download the helper files to get you started.
            </p>
